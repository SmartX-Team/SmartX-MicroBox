...
public class Elasticsearch_Connector_bak {
...
//    	index = response1.getAggregations().get("index").
	...
	public void insertPingLatencyDataRaw(String indexName, Date date, String source_site, String dest_site, float value) {
		// TODO Auto-generated method stub
		try {
    		XContentBuilder builder = jsonBuilder()
    			.startObject()
	...
	public void insertVcenterDataRaw(String indexName, Date date, String site, Integer value) {
		// TODO Auto-generated method stub
		try {
    		XContentBuilder builder = jsonBuilder()
    			.startObject()
