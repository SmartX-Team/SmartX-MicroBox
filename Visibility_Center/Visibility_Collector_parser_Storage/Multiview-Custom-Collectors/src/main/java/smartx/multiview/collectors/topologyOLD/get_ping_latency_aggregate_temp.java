package smartx.multiview.collectors.topologyOLD;
...
public class get_ping_latency_aggregate_temp  extends TimerTask {
	...
	public get_ping_latency_aggregate_temp(MongoDB_Connector mongoConnector2) {
	...
	private void get_pinglatency() throws ParseException {
		...
		// TODO Auto-generated method stub
				...
				System.out.println(today_now.getTime());
			        ...
			        String timeStamp = "2018/11/06";//2018/07/03
			       ...
			       /* for (Document document : documents) 
			        ...
			        document_pingscore.put("timestamp",   sdf.formatsimpleDateFormat.format(timestamp));
			        ...
			        */
			        ...
			        for (Document document : documents_OneDay) 
					{
			        	...
			        	{
			        		//System.out.println(document.getString("SmartX-Box-SOURCE"));
			        		System.out.println("Found MYREN in:"+document.toString());
			        		calculate_ping(document);
			        	}
					}
			        System.out.println("");
			        ...
			        uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_HUST= (float) (Box_HUST_ping/count_oneday_ping_SmartX_Box)*100;
