...
package smartx.multiview.collectors;
...
public class udpTopologyKafkaConsumer2 implements Runnable{
    ...
    public udpTopologyKafkaConsumer2(String bootstrapserver, MongoDB_Connector MongoConn) 
    {
