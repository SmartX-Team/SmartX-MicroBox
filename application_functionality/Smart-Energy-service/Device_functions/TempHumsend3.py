...
class EdgeX:
    def __init__(self, ip='IoT-Cloud Hub IP address'):
        self.ip = 'edgex-core-data'
        self.port = 31091
        self.metaIp = 'edgex-core-metadata'
        self.metaPort = 32007
...
while True:
    ...
    if t <= 35:
        ...
        url = "http://edgex-core-data:31091/api/v1/event"
        ...
        url = "http://api-server:32014" ##flask에 api 요청
